            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <!-- Usar el logo de la carpeta public/imgs -->
                        <img src="{{ asset('imgs/logotipo.jpg') }}" alt="Logo" class="block h-9 w-auto">
                    </a>
                </div>
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->type === 'admin')
                        ...
                        <x-nav-link :href="route('operUsers.index')" :active="request()->routeIs('operUsers.index')">
                            {{ __('Users') }}
                        </x-nav-link>
